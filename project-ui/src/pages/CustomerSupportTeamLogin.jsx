  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8090/teams/create",
        teamDetails
      );
          ...
          <div className="mt-3" style={{ ...outerContainerStyle }}>
            <div className="mt-3">
              <div className="mt-5" style={innerContainerStyle}>
                ...
                <h6 style={{ color: "#871f40" }}>
                  Sign in to access the support panel
                </h6>
                <form
                ...
                >
                  <div
                    className="login-input-container mt-3"
                    style={{ ...inputStyle }}
                  >
                  ...
                  <div
                    className="login-input-container mb-3"
                    style={{ ...inputStyle }}
                  >
