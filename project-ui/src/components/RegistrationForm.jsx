                                        ...
                                        <>
                                            <div className="row g-3 align-items-center mt-2">
                                                <div className="col-auto">
                                                    <label htmlFor="inputPassword6" className="form-label" style={{ color: '#871f40' }}>Enter Password:</label>
                                                </div>
                                            ...
                                            <div className="row g-3 align-items-center mt-3">
                                                <div className="col-auto">
                                                    <label htmlFor="inputPassword6" className="col-form-label" style={{ color: '#871f40' }}>Confirm Password:</label>
                                                </div>
                                                <div className="mb-3 col mt-3">
                                                    <input
                                                        type="password"
